            ...
            GM_xmlhttpRequest({
                ...
                onload: function(response) {
                    if (response.status >= 200 && response.status < 400){
                        ...
                        $(node).append("<div style='display: inline-flex;border: 1px;border-style: solid;'><img id='doubanIcon' src='https://images-na.ssl-images-amazon.com/images/G/01/imdb/images/plugins/imdb_46x22-2264473254._CB514892074_.png'/>" + $doc.find("span[itemprop='ratingValue']").text() + "</div>");
                    }
                    else{
